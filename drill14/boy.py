...
class Boy:
    ...
    def __init__(self):
        ...
        self.eating_ball_cnt = 0

    def get_bb(self):
        return self.canvas_width//2 - 25, self.canvas_height//2 - 50, self.canvas_width//2 + 25, self.canvas_height//2 + 60

    def eat(self):
        self.eating_ball_cnt+=1
    ...
    def draw(self):
        ...
        self.font.draw(self.canvas_width//2 - 60, self.canvas_height//2 + 50, '(%5d)' % self.eating_ball_cnt, (255, 255, 0))
